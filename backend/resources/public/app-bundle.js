...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Post = __webpack_require__(234);

	var _Post2 = _interopRequireDefault(_Post);

	var _PostForm = __webpack_require__(235);
	...
	var Layout = (_dec = (0, _reactRedux.connect)(function (store) {
	  ...
	  _createClass(Layout, [{
	    key: 'createPost',
	    value: function createPost(title, text, date) {
	      var _this2 = this;

	      this.props.dispatch(function (dispatch) {
	        _api2.default.createPost(title, text, date).then(function (response) {
	          _this2.fetchPosts();
	        });
	      });
	    }
	    ...
	    value: function deletePost(id) {
	      this.props.dispatch(function (dispatch) {
	        _api2.default.deletePost(id).then(function () {
	    ...
	    value: function fetchPosts() {
	      this.props.dispatch(function (dispatch) {
	        _api2.default.fetchPosts().then(function (response) {
	          dispatch((0, _actions.fetchPosts)(response.data));
	        });
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_PostForm2.default, { createPost: this.createPost.bind(this) }),
	        _react2.default.createElement(
	          ...
	          this.props.posts.map(function (post, i) {
	            return _react2.default.createElement(
	              'li',
	              { key: i },
	              _react2.default.createElement(_Post2.default, { post: post, deletePost: _this3.deletePost.bind(_this3) })
	            );
	          })
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var api = function () {
		...
		_createClass(api, null, [{
			key: "createPost",
			value: function createPost(title, text, date) {
				return _axios2.default.post("http://localhost:8090/api/post", { title: title, text: text, date: date });
			}
		}, {
			key: "deletePost",
			value: function deletePost(id) {
				return _axios2.default.delete("http://localhost:8090/api/post/" + id);
			}
		}, {
			key: "fetchPosts",
			value: function fetchPosts() {
				return _axios2.default.get("http://localhost:8090/api/posts");
			}
		}]);
	  ...
	  _createClass(Post, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.deleteHelper.bind(this) },
	          'Delete'
	        )
	      );
	    }
	  ...
	  _createClass(PostForm, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { type: 'button', onClick: this.createHelper.bind(this) },
	          'Create'
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var posts = function posts() {
		...
		switch (action.type) {
			case 'CREATE_POST':
				return _extends({}, state, { posts: state.posts.concat(action.post) });
			case 'DELETE_POST':
				return _extends({}, state, { posts: state.posts.filter(function (post) {
						return action.post.id != id;
					}) });
			case 'FETCH_POSTS':
				return _extends({}, state, { posts: action.posts });
			default:
				return state;
		}
	};
